...
public class CreateGroupPostController extends HttpServlet {
    ...
    private void createPost(HttpServletRequest request, HttpServletResponse response)
            ...
            while (i.hasNext()) {
                ...
                if (fi.isFormField()) {
                    ...
                    if(fieldName.equals("postBody")){
                        ...
                        //set the groupID of group to be posted to
        ...
        //Call createGroupPost method and pass in the post
        HandlePost handlePost = new HandlePost();
        handlePost.createGroupPost(post);
